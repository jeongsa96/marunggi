...
def HOME(request):
    ...
    context = {'pie':pie,'line':line,'random':random,'username':username}
...
def DATA(request):
    ...
    # jika ada perintah method get
        ...
        return render(request, 'admin/kelola-data.html')
...
def DELETE_USER(request, pk):
    ...
    user.delete()
    return render(request, 'admin/kelola-user.html')
...
def SA_HASIL_PREDIKSI(request):
    ...
    if request.method == 'POST':        
        ...
        if not date:
            ...
            context = {'list':list_penyakit,'chart':chart}
            return render(request, 'adminstrasi/hasil-prediksi.html', context)
